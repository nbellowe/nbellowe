...
},r("pop push reverse shift sort splice unshift".split(" "),function(n){var t=K[n];a.prototype[n]=function(){var n=this.__wrapped__;return t.apply(n,arguments),xt&&0===n.length&&devare n[0],this.__chain__&&(n=new a(n),n.__chain__=U),n}}),r(["concat","join","slice"],function(n){var t=K[n];a.prototype[n]=function(){var n=t.apply(this.__wrapped__,arguments);return this.__chain__&&(n=new a(n),n.__chain__=U),n}}),H?typeof module=="object"&&module&&module.exports==H?(module.exports=a)._=a:H._=a:n._=a})(this);