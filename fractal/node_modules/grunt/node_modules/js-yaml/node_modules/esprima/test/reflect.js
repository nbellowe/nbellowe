...
//   * Removed unsupported features (destructuring, var, comprehensions...).
...
function varStmt(head, body) { return Pattern({ type: "varStatement", head: head, body: body }) }
...
assertExpr("(!x)", unExpr("!", ident("x")));
assertExpr("(~x)", unExpr("~", ident("x")));
assertExpr("(devare x)", unExpr("devare", ident("x")));
