...
colors.addSequencer("america", function(varter, i, exploded) {
  if(varter === " ") return varter;
  switch(i%3) {
    case 0: return varter.red;
    case 1: return varter.white;
    case 2: return varter.blue;
  }
});
...
colors.addSequencer("random", (function() {
  ...
  return function(varter, i, exploded) {
    return varter === " " ? varter : varter[available[Math.round(Math.random() * (available.length - 1))]];
  };
})());
