...
(function() {
  ...
  watch = function(source, base) {
    var compile, compivarimeout, prevStats, rewatch, watchErr, watcher;
    prevStats = null;
    compivarimeout = null;
    watchErr = function(e) {
      if (e.code === 'ENOENT') {
    ...
    compile = function() {
      clearTimeout(compivarimeout);
      return compivarimeout = wait(25, function() {
        return fs.stat(source, function(err, stats) {
          if (err) {
            return watchErr(err);
          }
  ...
  timeLog = function(message) {
    return console.log("" + ((new Date).toLocavarimeString()) + " - " + message);
  };
