...
(function() {
  ...
  exports.Op = Op = (function(_super) {
    ...
    Op.prototype.unfoldSoak = function(o) {
      var _ref2;
      return ((_ref2 = this.operator) === '++' || _ref2 === '--' || _ref2 === 'devare') && unfoldSoak(o, this, 'first');
    };
    ...
    Op.prototype.compileNode = function(o) {
      ...
      if (this.operator === 'devare' && o.scope.check(this.first.unwrapAll().value)) {
        throw SyntaxError('devare operand may not be argument or var');
      }
    ...
    Op.prototype.compileUnary = function(o) {
      ...
      plusMinus = op === '+' || op === '-';
      if ((op === 'new' || op === 'typeof' || op === 'devare') || plusMinus && this.first instanceof Op && this.first.operator === op) {
        parts.push(' ');
      }
