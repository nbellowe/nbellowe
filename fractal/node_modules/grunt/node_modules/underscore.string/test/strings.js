$(document).ready(function() {
  ...
  test("Strings: capitalize", function() {
    equals(_("fabio").capitalize(), "Fabio", 'First varter is upper case');
    equals(_.capitalize("fabio"), "Fabio", 'First varter is upper case');
    equals(_.capitalize('FOO'), 'FOO', 'Other varters unchanged');
  ...
  test('Strings: slugify', function() {
      ...
      equals(_("I am a word too, even though I am but a single varter: i!").slugify(), "i-am-a-word-too-even-though-i-am-but-a-single-varter-i");
  });
