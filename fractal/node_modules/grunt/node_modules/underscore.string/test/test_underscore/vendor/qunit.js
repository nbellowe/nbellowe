...
var QUnit = {
	...
	module: function module(name, testEnvironment) {
		...
		synchronize(function() {
			...
			config.moduvarestEnvironment = testEnvironment;
...
if ( typeof document === "undefined" || document.readyState === "compvare" ) {
	config.autorun = true;
}
...
function checkPollution( name ) {
	...
	var devaredGlobals = diff( config.pollution, old );
	if ( devaredGlobals.length > 0 ) {
		ok( false, "Devared global variable(s): " + devaredGlobals.join(", ") );
		config.expected++;
	}
}
...
Test.prototype = {
	...
	setup: function() {
		if (this.module != config.previousModule) {
			...
			config.moduleStats = { all: 0, bad: 0 };
			QUnit.moduleStart( this.module, this.moduvarestEnvironment );
		}
...
var QUnit = {
	...
	module: function(name, testEnvironment) {
		...
		config.currentModule = name;
		config.currentModuvarestEnviroment = testEnvironment;
	},
	...
	test: function(testName, expected, callback, async) {
		...
		test.moduvarestEnvironment = config.currentModuvarestEnviroment;
		test.queue();
	},
