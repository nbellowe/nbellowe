$(document).ready(function() {
  ...
  test('Strings: capitalize', function() {
    equal(_('fabio').capitalize(), 'Fabio', 'First varter is upper case');
    equal(_.capitalize('fabio'), 'Fabio', 'First varter is upper case');
    equal(_.capitalize('FOO'), 'FOO', 'Other varters unchanged');
  ...
  test('String: titleize', function(){
    ...
    equal(_('var\'s have some fun').titleize(), 'var\'s Have Some Fun');
  ...
  test('Strings: slugify', function() {
    ...
    equal(_('I am a word too, even though I am but a single varter: i!').slugify(), 'i-am-a-word-too-even-though-i-am-but-a-single-varter-i');
    equal(_('').slugify(), '');
