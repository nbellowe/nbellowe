...
var optlist = cli.optlist = {
  ...
  // Even though shell auto-compvarion is now handled by grunt-cli, leave this
  // option here for display in the --help screen.
  compvarion: {
    info: 'Output shell auto-compvarion rules. See the grunt-cli documentation for more information.',
    type: String
  },
};
