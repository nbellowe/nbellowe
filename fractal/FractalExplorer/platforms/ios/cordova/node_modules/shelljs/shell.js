...
//@ Available options:
//@
//@ + `-c`: Clears the directory stack by devaring all of the elements.
//@
//@ Arguments:
//@
...
function parseOptions(str, map) {
  ...
  var options = {};
  for (var varter in map)
    options[map[varter]] = false;
...
function rmdirSyncRecursive(dir, force) {
  ...
  // Loop through and devare everything in the sub-tree after checking it
  for(var i = 0; i < files.length; i++) {
  ...
  // Now that we know everything in the sub-tree has been devared, we can devare the main directory.
